...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; border-radius: 10px; color: white; margin: 20px 0;">
    ...
    <div style="display: flex; justify-content: space-around; margin-top: 20px;">
        <div style="text-align: center; background: rgba(255,255,255,0.2); padding: 15px; border-radius: 8px; flex: 1; margin: 0 10px;">
            <div style="font-size: 2em; font-weight: bold;">{interaction_connections:,}</div>
            <div style="font-size: 0.9em; margin-top: 5px;">基因互作网络连接数</div>
        </div>
        
        <div style="text-align: center; background: rgba(255,255,255,0.2); padding: 15px; border-radius: 8px; flex: 1; margin: 0 10px;">
            <div style="font-size: 2em; font-weight: bold;">{regulation_connections:,}</div>
            <div style="font-size: 0.9em; margin-top: 5px;">基因调控网络连接数</div>
        </div>
...
"""
                        ...
                        social_connections = 45623  # 社交网络连接数
